...
POSTS = [
    ("迎新晚会等你来！", "本周五晚七点，大学生活动中心大礼堂举办迎新晚会，节目超精彩，现场还有抽奖，欢迎所有同学来玩～", "activity", None, [0], 0, 40),
    ("篮球联赛报名开始了", "校级篮球联赛开始报名啦，以学院为单位组队，每队限12人。报名截止本周日，详情私我或加 QQ 12345678。", "activity", None, [1], 1, 300),
    ("读书分享会：《活着》", "周五下午三点图书馆三楼会议室，我们一起聊聊余华的《活着》，欢迎带上自己的读书笔记。", "activity", None, [], 4, 600),
    ...
    ("出九成新山地自行车", "毕业出自行车，捷安特山地车，骑了半年，换胎无暗病，500 元自提，可小刀。联系方式见评论。", "ad", "闲置", [0], 0, 30),
    ("大一高数课本+习题集", "出大一上下高数教材和配套习题集，几乎全新带笔记，40 元打包。", "ad", "闲置", [], 4, 200),
    ("寻物启事：灰色钱包", "昨天下午在图书馆三楼丢失灰色钱包，内有校园卡和学生证，捡到的同学请联系我，感谢！", "ad", "求助", [], 1, 400),
    ("图书馆占座拼学习搭子", "有没有同学每天一起去图书馆学习的，互相占座打卡监督，加个好友一起冲绩点～", "ad", "求助", [], 3, 800),
    ("驾校学车暑期团报", "学校旁边驾校暑期团报优惠，三人成团减 200，练车接送，需要的同学私信我组队。", "ad", "宣传", [5], 2, 1300),
    ("校内打印店开业大酬宾", "二食堂旁新开打印店，黑白 0.1 元/页，彩印 0.5 元/页，开业三天送文件袋。", "ad", "宣传", [], 0, 2000),
