...
MAP_CENTER = (118.007853, 36.814398)

# 校园地点库（与前端 frontend/src/api/const.js CAMPUS_PLACES 保持一致）
# (名称, 经度, 纬度)
CAMPUS_PLACES = [
    ("北门（新村西路）", 118.006732, 36.816583),
    ("图书馆", 118.006431, 36.815182),
    ("鸿远楼（行政楼）", 118.007535, 36.814284),
    ("一号教学楼", 118.008939, 36.81599),
    ("二号教学楼", 118.007836, 36.815786),
    ("三号教学楼", 118.005829, 36.813579),
    ("逸夫楼", 118.006331, 36.81268),
    ("第一食堂（一餐）", 118.010043, 36.815693),
    ("第二食堂（二餐）", 118.009541, 36.81309),
    ("第三食堂（三餐）", 118.005528, 36.815479),
    ("体育馆", 118.011146, 36.813595),
    ("田径场", 118.010344, 36.814493),
    ("学生公寓区", 118.008137, 36.816988),
    ("大学生事务中心", 118.006832, 36.814182),
    ("校医院", 118.005027, 36.814677),
    ("东门", 118.012752, 36.8144),
    ("南门", 118.007835, 36.812584),
]
